...
class _DashboardScreen extends State<DashboardScreen> {
  ...
  List bannerImageUrls = [];
  Future<void> fetchBannerImages() async {
    final response = await http.post(
        Uri.parse('https://excellis.co.in/420-society-world/api/v1/cms/home'));
      ...
      body: ListView(
        children: <Widget>[
          ...
          Container(
              ...
              child: bannerImageUrls.isNotEmpty
                      ...
                      slideBuilder: (index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: NetworkImage(
                                  "https://excellis.co.in/420-society-world/public/storage/${bannerImageUrls[index]['banner_img']}"),
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: Column(
                            ...
                            children: [
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text: bannerImageUrls[index]['title_1'] ??
                                          "",
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.white,
                                    ...
                                    TextSpan(
                                      text: bannerImageUrls[index]['title_2'] ??
                                          "",
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.white,
